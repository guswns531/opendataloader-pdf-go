...
| `--format`                  | `-f`  | `[]string` | `json`       | Output formats (comma-separated). Values: json, text, html, pdf, markdown, markdown-with-html, markdown-with-images. Default: json |
...
| `--hybrid-timeout`          | -     | `integer`  | `30000`      | Hybrid backend request timeout in milliseconds. Default: 30000                                                                     |
