...
ence efficiently. We show experimentally that DUS is simple yet effective in scaling up high-scaling the base model along the depth dimension
...
Equal ContributionCorresponding Author 1	2.0 license, we aim to promote collaboration and in-