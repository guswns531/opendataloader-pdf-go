...
Tuning (RAFT) (Dong et al., 2023), and Direct Policy Optimization (DPO) (Intel, 2023). They
  ...
  B. 4 Instruction Tuning avoid the complexities associated with reinforce-
...
Before instruction tuning, existing methods faced challenges in effectively guiding and control- ling the behavior of large language models ( Zhang
