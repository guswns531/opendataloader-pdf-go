...
parameters. Naturally, this leads to the removal of
  ...
  2 Depth Up-Scaling m = 8 layers. The depthwise scaling process with n = 32, s= 48,and m = 8 is depicted in ‘Step 1:
...
MoE (Shazeer et al., 2017) to scale-up the model ar- developed.
...
### Depthwise scaling.From the base model withn
  ...
  i. e.,from n to2n layers. Then, the ‘layer distance’,
...
remove the finalm layers from the original model
...
## model withs = 2·(n− m )layers. Note thatn = 32	2